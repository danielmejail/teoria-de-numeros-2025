...
\begin{proof}[\proofname~del \lemaname~\ref{lema:generos}]
	...
	\begin{proof}[\proofname~de~\ref{item:lema:generos:nucleo}]
		...
		\footnote{
			Si $m=f(x,y)$, con $x,y\in\Enteros$,
			considerar la funci\'on $g(u,v)=f(x+uD,y+vD)$.
			Se cumple
			% \begin{displaymath}
				% g(u,v)\,=\,m\,+\,
					% \Big((2ax+by)\,u+(2cy+bx)\,v\Big)\,D
					% \,+\, f(u,v)\,D^2
				% \dispstop
			% \end{displaymath}
			% %
			% Entonces, con $f(u,v)=au^2+buv+cv^2$,
			% \begin{displaymath}
				% \begin{aligned}
					% \partial_u\,g(u,v) & \,=\,
						% \partial_u\,f(u,v)\,D^2\,+\,
			...
			\begin{displaymath}
				\begin{vmatrix}
					\partial_{uu}\,g & \partial_{uv}\,g \\
					\partial_{vu}\,g & \partial_{vv}\,g
				\end{vmatrix}\,(u,v)\,=\,
				\begin{vmatrix}
					2a & b \\ b & 2c
				\end{vmatrix}\,D^4\,=\,-D^5
			...
			\end{displaymath}
			%
			En particular, si $D>0$, la hessiana es negativa.
		}
...
\input{./tex/generos/ejercicios-propiedades.tex}
